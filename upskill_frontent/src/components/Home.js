...
//       <div className="video-container">
//         <video autoPlay loop muted>
//           <source src={require('../assets/bg_video2.mp4')} type="video/mp4" />
//           Your browser does not support the video tag.
//         </video>
//       </div>
//       <div className="content">
...
//           <button className="show-number" onClick={handleShowNumberClick}>
//             <FontAwesomeIcon icon={faPhone} />
//             {showNumber ? ' 07947142823' : 'Let `s connect'}
//           </button>
//         </div>
...
const Home = () => {
  ...
  useEffect(() => {
    const studentTarget = 40;
    const teacherTarget = 2;
    let studentInterval, teacherInterval;
